...
# General parameters
name = 'EcanHydroLM'
main_package = 'ecanhydrolm'
# datasets = 'datasets'
version = '0.0.1'
descrip = 'HydroLM for Ecan data systems'
...
if os.environ.get('READTHEDOCS', False) == 'True':
    ...
    INSTALL_REQUIRES = ['pdsql', 'hydrolm']
...
setup(
    ...
    url='https://github.com/Data-to-Knowledge/EcanHydroLM',  # Optional
    ...
    keywords='ecan regressions',  # Optional
